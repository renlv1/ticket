<template>
  <div class="past-record">
    ...
    <div class="content-box">
      ...
      <ul class="uls">
        <li class="li-item guess-uls" v-for="(list,index) in newactivityArr" :key="index" :class="{'all-active': list.allin === true}">
          <div class="li-title">{{$t('record.text69')}}{{list[0].activityName}}{{$t('record.text1')}}</div>
          <div v-for="(item,index) in list" :key="index" ref="recordList" @click="toDetail(item)">
            ...
            <div class="li-content" >
              ...
              <ul class="img-box">
                ...
                <!--                  <div class="number">{{item.num4}}</div>-->
                <!--                </li>-->
                <!--                <li class="img-item">-->
                <!--                  <img :src="item.imgUrl5">-->
                <!--                  <div class="number">{{item.num5}}</div>-->
                <!--                </li>-->
                <!--                <li class="img-item">-->
                <!--                  <img :src="item.imgUrl6">-->
                <!--                  <div class="number">{{item.num6}}</div>-->
                <!--                </li>-->
...
<!--      :options="options"-->
<!--      :data="recordList"-->
<!--      @pulling-up="onPullingDown2"  v-show="queryId > 0">-->
<!--      <ul class="uls">-->
...
<!--          <div>-->
<!--            &lt;!&ndash;              <div class="li-title">{{$t('record.text69')}}{{item.activityName}}{{$t('record.text1')}}</div>&ndash;&gt;-->
<!--            <div class="li-content" >-->
<!--              <div class="content-title">-->
<!--                <span>{{$t('record.text2')}}：{{item.id}}</span>-->
<!--                &lt;!&ndash;                <span class="win-t" v-if="item.status === 1 ||  noLottery === 4">未开奖</span>&ndash;&gt;-->
<!--                <span class="win-t">{{winResult(item.winStatus, item.winnerNumber)}}</span>-->
<!--              </div>-->
<!--              <ul class="img-box">-->
<!--                <li class="img-item" ref="recordRef" v-for="(num, index) in 6" :key="index">-->
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 我的投注详情
      toDetail(item) {
        let item2 = this.newactivityArr[0]
        this.$router.push({
          path: '/lotteryResult',
          query: {
            activityId: item.id
